...
export default class RoomFilters extends React.Component<IRoomFilterProps, IRoomFilterStates> {
    ...
    private _getRoomLocation = () => {
        debugger;
        this.spRoomService.getRoomLocation(this.props.siteUrl).then(res=>{
            this.setState({
                roomLocations : res,
            });
         }).catch((error)=>{
    ...
    private _getRoomAreaBySelectedId = (obj) => { 
        ...
        this.spRoomService.getRoomAreaByLocation(this.props.siteUrl, obj.key).then(res=>{
            this.setState({
    ...
    private _getRoomBuildingFloorBySelectedId = (obj) => {
        ...
        this.spRoomService.getRoomBuildingByArea(this.props.siteUrl, obj.key).then(res=>{
            this.setState({
    ...
    private _getRoomSizeBySelectedId = (obj) => {
        ...
        this.spRoomService.getRoomSizeByBuilding(this.props.siteUrl, obj.key).then(res=>{
           this.setState({
