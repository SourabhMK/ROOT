...
export default class Department extends React.Component<IDepartmentProps, IDepartmentState, {}> {
  ...
  {    
    ...
    headers.append("accept", "application/json;odata.metadata=none");
        ...
        await this.props.spHttpClient
        .get(`${this.props.siteurl}/_api/web/lists/getbytitle('ObjectivesAndGoals')/items?$select=ID,Title,Goal,Interval,ExpandableOptions/Id,ExpandableOptions/Title&$expand=ExpandableOptions/Id,ExpandableOptions/Title&$filter=((ExpandableOptionsId eq '2') and (Interval eq 'Monthly Target'))`,
  ...
  {    
    ...
    headers.append("accept", "application/json;odata.metadata=none");
        ...
        await this.props.spHttpClient
        .get(`${this.props.siteurl}/_api/web/lists/getbytitle('ObjectivesAndGoals')/items?$select=ID,Title,Goal,Interval,ExpandableOptions/Id,ExpandableOptions/Title&$expand=ExpandableOptions/Id,ExpandableOptions/Title&$filter=((ExpandableOptionsId eq '2') and (Interval eq 'Quarterly Objectives'))`,
    ...
    return (
      <div className={ styles.department }>
        <div className={ styles.container }>         
            <h2> Objectives and Goals for Department </h2>
