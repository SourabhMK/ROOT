                ...
                <Callout
                  ...
                  <div className={(styles.calloutCard,styles.emailMainContent)}>
                    ...
                    <div className={styles.SetSaveBtn}>         
                      <div><PrimaryButton style={{border:'1px solid #ddd',backgroundColor:'rgb(239, 135, 0)',color:'#fff', width:'100%'}} onClick={()=>this.SaveDataClicked(this.state.message,this.state.selectedImage)}>Send</PrimaryButton></div>                        
                    </div>             
                  </div>
                </Callout> 
                )} 
